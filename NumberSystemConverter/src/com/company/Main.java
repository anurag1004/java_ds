...
class Number{
    ...
    private Map<Character, Integer> hexatoDec; // for hexadecimal to decimal conversion
...
public class Main {
    ...
    public static void main(String[] args) {
        Number n1 = new Number("10A",16);
        System.out.println(n1.toBase(10));
        System.out.println(Integer.toString(Integer.parseInt("10A",16),2));
    }
}
